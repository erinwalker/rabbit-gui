...
public class Renderer {
	...
	public static void drawTexturedModalRect(int posX, int posY, int uPos, int vPos, int width, int height) {
		...
		tessellator.addVertexWithUV(posX + 0, posY + height, 0, (uPos + 0) * f, (vPos + height) * f);
		tessellator.addVertexWithUV(posX + width, posY + height, 0, (uPos + width) * f, (vPos + height) * f);
		tessellator.addVertexWithUV(posX + width, posY + 0, 0, (uPos + width) * f, (vPos + 0) * f);
		tessellator.addVertexWithUV(posX + 0, posY + 0, 0, (uPos + 0) * f, (vPos + 0) * f);
		tessellator.draw();
	}
	...
	public static void drawTexturedModalRect(int xPos, int yPos, int u, int v, int imageWidth, int imageHeight,
		...
		tessellator.addVertexWithUV(xPos + imageWidth, yPos + imageHeight, zLevel, (u + imageWidth) * f,
				(v + imageHeight) * f1);
